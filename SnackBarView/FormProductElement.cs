...
{
    public partial class FormProductElement : Form
    {
        [Dependency]
        public new IUnityContainer Container { get; set; }

        public ModelProdComponentView Model { set { model = value; } get { return model; } }

        private readonly InterfaceComponentService service;

        private ModelProdComponentView model;

        public FormProductElement(InterfaceComponentService service)
        {
            InitializeComponent();
        ...
        private void FormProductComponent_Load(object sender, EventArgs e)
        {
            try
            {
                List<ModelComponentView> list = service.getList();
                if (list != null)
                {
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (model == null)
                {
                    model = new ModelProdComponentView
                    {
