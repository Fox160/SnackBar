...
namespace SnackBarRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<InterfaceCustomerService, CustomerServiceDB>(new HierarchicalLifetimeManager());
            container.RegisterType<InterfaceComponentService, ElementServiceDB>(new HierarchicalLifetimeManager());
            container.RegisterType<InterfaceExecutorService, ExecutorServiceDB>(new HierarchicalLifetimeManager());
            container.RegisterType<InterfaceOutputService, OutputServiceDB>(new HierarchicalLifetimeManager());
